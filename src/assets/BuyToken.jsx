    ...
    <>
      ...
      >
        <motion.div
          ...
          className={`bg-white rounded-xl border lg:w-1/2 w-11/12 ${proceed && "hidden"
            }`}
        >
          ...
          <div className="py-4 lg:px-14 px-5">
            ...
            <div className="pt-5 pb-9">
              ...
              <div className="flex lg:flex-nowrap	 flex-wrap justify-between">
                <button
                  className={`border-2 border-border rounded-full lg:rounded-lg w-full lg:w-72 h-12 mb-3 lg:mb-0 lg:mr-5 text-token text-base font-semibold hover:bg-green hover:text-dashbg duration-300 ${card && "!bg-dark border-dark !text-dashbg"
                    }`}
                  onClick={() => {
                    setIsCardPay(true);
                    setCard(true);
                ...
                <button
                  className={`border-2 border-border rounded-full lg:rounded-lg w-full lg:w-72 h-12 text-token text-base font-semibold hover:bg-green hover:text-dashbg duration-300 ${card2 && "!bg-dark border-dark !text-dashbg"
                    }`}
                  onClick={() => {
    ...
    <>
      ...
      >
        <motion.div
          ...
          className={`lg:w-2/5 w-11/12 bg-white rounded-xl absolute border-green ${success && "hidden"
            }`}
        >
