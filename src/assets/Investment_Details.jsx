    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className={`bg-white rounded-xl border w-11/12 lg:w-1/2 z-10 ${isClick ? "hidden" : "block"
            }`}
        >
  ...
  return (
    <>
      <motion.div
        ...
        className={`lg:w-128 w-11/12 bg-white rounded-xl absolute border-green p-6 text-center ${!instant || !success ? "block" : "hidden"
          } `}
      >
        <div>
      ...
      {instant && (
        <motion.div
          ...
          className={`lg:w-128 w-11/12 bg-white rounded-xl absolute border-green p-6 text-center ${warning ? "block" : "hidden"
            } `}
        >
          <div>
      ...
      {success && (
        <motion.div
          ...
          className={`w-11/12 lg:w-128 bg-white rounded-xl absolute border-green p-6 text-center ${!instant ? "block" : "hidden"
            } `}
        >
          <div>
  ...
  return (
    <>
      <motion.div
        ...
        className={`w-11/12 lg:w-128 bg-white rounded-xl absolute border-green p-6 text-center ${bvn ? "block" : "hidden"
          }`}
      >
        <div>
