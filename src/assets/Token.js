                    ...
                    <div className='w-full flex'>
                        <div className='w-1/2 mr-2'>
                            <div className='bg-welcome p-10 rounded-lg border flex justify-between items-center'>
                                <p className='font-medium text-base text-dark'>Easy Withdrawal to Local Bank</p>
                                <div>
                                    <button className='w-48 h-12 rounded-full bg-green text-white text-base font-medium'>Withdraw Token</button>
                                </div>
                            </div>
                            <div className='my-5'>
                                <motion.div 
                                    ...
                                    <div className='py-10 px-10'>
                                        <div className='pb-4 flex items-center'>
                                            <img src={reictoken} alt="my-investment-image" className='w-8' />
                                            <div className='ml-4 flex items-center'>
                                                <span className='text-tokentext text-xl font-extra-bold mr-2'>1</span> 
                                                <span className='text-token uppercase text-sm font-semibold mr-2'> reic token</span> 
                                                <span className='text-tokentext text-xl font-semibold'> = N50,000</span>
                                            </div>
                                        </div>
                        ...
                        <div className='w-1/2 ml-2 font-inter'>
                            <motion.div 
                                    ...
                                    <div className='px-10 py-3 recent'>
                                        <h1 className='text-green text-lg font-semibold mb-3'>Token Purchase</h1>
                                        <div className='flex'>
                                            <p className='w-2/3 font-normal text-sm text-footer'><span>You</span> made a deposit of <span className=''>N20,000</span> purchase of <span>REIC Token</span>, Transaction ID: <span>UTTA005129</span></p>
                                            <p className='w-1/3 font-bold text-xs text-footer text-right'>Jul 22, 2:45pm</p>
                                        </div>
                                    </div>
                                    <div className='px-10 py-3 recent'>
                                        <h1 className='text-green text-lg font-semibold mb-3'>Token Purchase</h1>
                                    ...
                                    <div className='px-10 py-3 recent'>
                                        <h1 className='text-green text-lg font-semibold mb-3'>Withdrawal</h1>
                                        <div className='flex'>
                                            <p className='w-2/3 font-normal text-sm text-footer'><span>You</span> made a Withdrawal of <span className=''>N20,000</span> to your bank, Transaction ID: <span>UTTA005129</span></p>
                                            <p className='w-1/3 font-bold text-xs text-footer text-right'>Jul 22, 2:45pm</p>
                                        </div>
                                    </div>
                                    <div className='px-10 py-3 recent'>
