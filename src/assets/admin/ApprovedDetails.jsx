...
function ApprovedDetails({ setDetails, itemId, fetchApproved }) {
      ...
      >
        ...
        {turn && (
          <motion.div
            ...
            className={`lg:w-128 w-11/12 bg-white rounded-xl fixed top-48 border-green p-6 text-center ${turn ? "block" : "hidden"
              } `}
          >
            <div>
...
function Warning({ closeWarning, title, fetchApproved, setDetails, itemId }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="font-semibold lg:text-base text-xs text-neutral my-8">
          <p>
            Are you sure you want to deactivate <br /> the
            <span className="text-green"> {title}</span> investments?
          </p>
        </div>
        <div className="flex justify-between">
          <button
...
function Processing({ fetchApproved, setDetails, itemId }) {
  ...
  return (
    <>
      <motion.div
        ...
        className={`w-11/12 lg:w-128 bg-white rounded-xl fixed top-48 border-green p-6 text-center ${success ? "hidden" : "block"
          }`}
      >
        <div>
      ...
      {success && (
        ...
        >
          ...
          <div className="font-semibold text-sm lg:text-base text-neutral my-8">
            <p>You have successfully deactivated this product investment</p>
          </div>
          <div className="">
            <button
