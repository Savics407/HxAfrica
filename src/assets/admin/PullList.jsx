...
function PullList() {
  ...
  async function fetchPullFunds() {
    ...
    const response = await fetch(
      `${import.meta.env.REACT_APP_MY_API_ENDPOINT}admin/fetch_pullout_funds_request`,
      {
        method: "POST",
        headers: {
  ...
  async function approvePullout(id) {
    ...
    // alert(payLoad.id);
    const response = await fetch(
      `${import.meta.env.REACT_APP_MY_API_ENDPOINT}admin/approve_merchant_pullout_product_funds`,
      {
        method: "POST",
  ...
  async function updateSent(id) {
    ...
    // alert(payLoad.id);
    const response = await fetch(
      `${import.meta.env.REACT_APP_MY_API_ENDPOINT}admin/update_sent`,
      {
        method: "POST",
        body: JSON.stringify(payLoad),
        headers: {
  ...
  async function checkSent() {
    ...
    // e.preventDefault();
    const response = await fetch(
      `${import.meta.env.REACT_APP_MY_API_ENDPOINT}admin/check_sent`,
      {
        method: "POST",
        headers: {
          "Content-type": "application/json",
